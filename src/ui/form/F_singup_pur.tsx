				...
				<form className="bg-grey-lightest w-full pt-4" onSubmit={form.handleSubmit(onSubmit)}>
					<div className="container mx-auto py-8">
									...
									render={({ field }) => (
										<FormItem>
											<div className="flex flex-row ">
												<User2 className="w-5" />
												<FormLabel className="text-grey-darker mx-2  mb-2 block pt-1 text-sm font-bold">닉네임</FormLabel>
											</div>
											<FormControl>
						...
						<p className="my-4 text-center">
							<a href="#" className="text-grey-dark hover:text-grey-darker text-sm no-underline">I already have an account</a>
						</p>
					</div>
				</form>
			</Form>
